...
func (x *DockerHub) GetCredential() isDockerHub_Credential {
	if x != nil {
		return x.Credential
	}
	return nil
...
func (x *DockerHub) GetUnauthenticated() *credentialspb.Unauthenticated {
	if x != nil {
		if x, ok := x.Credential.(*DockerHub_Unauthenticated); ok {
			return x.Unauthenticated
		}
	}
	return nil
...
func (x *DockerHub) GetBasicAuth() *credentialspb.BasicAuth {
	if x != nil {
		if x, ok := x.Credential.(*DockerHub_BasicAuth); ok {
			return x.BasicAuth
		}
	}
	return nil
...
func (x *DockerHub) GetToken() string {
	if x != nil {
		if x, ok := x.Credential.(*DockerHub_Token); ok {
			return x.Token
		}
	}
	return ""
...
const file_sources_proto_rawDesc = "" +
	...
	"\rskip_archives\x18\b \x01(\bR\fskipArchivesB\f\n" +
	"\n" +
	"credential\"V\n" +
	"\bCircleCI\x12$\n" +
	"\bendpoint\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x90\x01\x01R\bendpoint\x12\x16\n" +
	...
	"\x06images\x18\x05 \x03(\tR\x06imagesB\f\n" +
	"\n" +
	"credential\"l\n" +
	"\x03ECR\x127\n" +
	"\n" +
	...
	"\rinclude_wikis\x18\x13 \x01(\bR\fincludeWikisB\f\n" +
	"\n" +
	"credential\"B\n" +
	"\vGoogleDrive\x12%\n" +
	...
	"\x0eignore_buckets\x18\b \x03(\tR\rignoreBucketsB\f\n" +
	"\n" +
	"credential\"\xc4\x01\n" +
	"\x05Slack\x12$\n" +
	"\bendpoint\x18\x01 \x01(\tB\b\xfaB\x05r\x03\x90\x01\x01R\bendpoint\x12\x16\n" +
	...
	"ignoreList\x12\x19\n" +
	"\bteam_ids\x18\x06 \x03(\tR\ateamIdsB\f\n" +
	"\n" +
	"credential\"\x95\x01\n" +
	"\x06Syslog\x12\x1a\n" +
	...
	" \x01(\bR\x0ebestEffortScan\"\xe1\x02\n" +
	"\tDockerHub\x12H\n" +
	"\x0funauthenticated\x18\x01 \x01(\v2\x1c.credentials.UnauthenticatedH\x00R\x0funauthenticated\x127\n" +
	"\n" +
	"basic_auth\x18\x02 \x01(\v2\x16.credentials.BasicAuthH\x00R\tbasicAuth\x12\x16\n" +
	"\x05token\x18\x03 \x01(\tH\x00R\x05token\x12$\n" +
	"\rorganizations\x18\x04 \x03(\tR\rorganizations\x12\"\n" +
	"\frepositories\x18\x05 \x03(\tR\frepositories\x12!\n" +
	"\fignore_repos\x18\x06 \x03(\tR\vignoreRepos\x12#\n" +
	"\rinclude_repos\x18\a \x03(\tR\fincludeRepos\x12\x19\n" +
	"\bmax_tags\x18\b \x01(\x05R\amaxTagsB\f\n" +
	"\n" +
	"credential*\x8a\b\n" +
	"\n" +
	"SourceType\x12\x1d\n" +
	...
	"\x19SOURCE_TYPE_ELASTICSEARCH\x10#\x12\x19\n" +
	"\x15SOURCE_TYPE_DOCKERHUB\x10$B;Z9github.com/trufflesecurity/trufflehog/v3/pkg/pb/sourcespbb\x06proto3"
...
var file_sources_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_sources_proto_goTypes = []any{
	...
	(*DockerHub)(nil),                           // 35: sources.DockerHub
	(*durationpb.Duration)(nil),                 // 36: google.protobuf.Duration
	(*anypb.Any)(nil),                           // 37: google.protobuf.Any
	(*credentialspb.BasicAuth)(nil),             // 38: credentials.BasicAuth
	(*credentialspb.Unauthenticated)(nil),       // 39: credentials.Unauthenticated
	(*credentialspb.Oauth2)(nil),                // 40: credentials.Oauth2
	(*credentialspb.KeySecret)(nil),             // 41: credentials.KeySecret
	(*credentialspb.CloudEnvironment)(nil),      // 42: credentials.CloudEnvironment
	(*credentialspb.SSHAuth)(nil),               // 43: credentials.SSHAuth
	(*credentialspb.GitHubApp)(nil),             // 44: credentials.GitHubApp
	(*credentialspb.AWSSessionTokenSecret)(nil), // 45: credentials.AWSSessionTokenSecret
	(*credentialspb.SlackTokens)(nil),           // 46: credentials.SlackTokens
	(*credentialspb.Header)(nil),                // 47: credentials.Header
	(*credentialspb.ClientCredentials)(nil),     // 48: credentials.ClientCredentials
	(*timestamppb.Timestamp)(nil),               // 49: google.protobuf.Timestamp
}
var file_sources_proto_depIdxs = []int32{
	36, // 0: sources.LocalSource.scan_interval:type_name -> google.protobuf.Duration
	37, // 1: sources.LocalSource.connection:type_name -> google.protobuf.Any
	38, // 2: sources.Artifactory.basic_auth:type_name -> credentials.BasicAuth
	39, // 3: sources.Artifactory.unauthenticated:type_name -> credentials.Unauthenticated
	38, // 4: sources.AzureStorage.basic_auth:type_name -> credentials.BasicAuth
	39, // 5: sources.AzureStorage.unauthenticated:type_name -> credentials.Unauthenticated
	40, // 6: sources.Bitbucket.oauth:type_name -> credentials.Oauth2
	38, // 7: sources.Bitbucket.basic_auth:type_name -> credentials.BasicAuth
	39, // 8: sources.Confluence.unauthenticated:type_name -> credentials.Unauthenticated
	38, // 9: sources.Confluence.basic_auth:type_name -> credentials.BasicAuth
	1,  // 10: sources.Confluence.spaces_scope:type_name -> sources.Confluence.GetAllSpacesScope
	39, // 11: sources.Docker.unauthenticated:type_name -> credentials.Unauthenticated
	38, // 12: sources.Docker.basic_auth:type_name -> credentials.BasicAuth
	41, // 13: sources.ECR.access_key:type_name -> credentials.KeySecret
	39, // 14: sources.GCS.unauthenticated:type_name -> credentials.Unauthenticated
	42, // 15: sources.GCS.adc:type_name -> credentials.CloudEnvironment
	40, // 16: sources.GCS.oauth:type_name -> credentials.Oauth2
	38, // 17: sources.Git.basic_auth:type_name -> credentials.BasicAuth
	39, // 18: sources.Git.unauthenticated:type_name -> credentials.Unauthenticated
	43, // 19: sources.Git.ssh_auth:type_name -> credentials.SSHAuth
	40, // 20: sources.GitLab.oauth:type_name -> credentials.Oauth2
	38, // 21: sources.GitLab.basic_auth:type_name -> credentials.BasicAuth
	44, // 22: sources.GitHub.github_app:type_name -> credentials.GitHubApp
	39, // 23: sources.GitHub.unauthenticated:type_name -> credentials.Unauthenticated
	38, // 24: sources.GitHub.basic_auth:type_name -> credentials.BasicAuth
	38, // 25: sources.JIRA.basic_auth:type_name -> credentials.BasicAuth
	39, // 26: sources.JIRA.unauthenticated:type_name -> credentials.Unauthenticated
	40, // 27: sources.JIRA.oauth:type_name -> credentials.Oauth2
	39, // 28: sources.NPMUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	39, // 29: sources.PyPIUnauthenticatedPackage.unauthenticated:type_name -> credentials.Unauthenticated
	41, // 30: sources.S3.access_key:type_name -> credentials.KeySecret
	39, // 31: sources.S3.unauthenticated:type_name -> credentials.Unauthenticated
	42, // 32: sources.S3.cloud_environment:type_name -> credentials.CloudEnvironment
	45, // 33: sources.S3.session_token:type_name -> credentials.AWSSessionTokenSecret
	46, // 34: sources.Slack.tokens:type_name -> credentials.SlackTokens
	38, // 35: sources.Gerrit.basic_auth:type_name -> credentials.BasicAuth
	39, // 36: sources.Gerrit.unauthenticated:type_name -> credentials.Unauthenticated
	38, // 37: sources.Jenkins.basic_auth:type_name -> credentials.BasicAuth
	47, // 38: sources.Jenkins.header:type_name -> credentials.Header
	39, // 39: sources.Jenkins.unauthenticated:type_name -> credentials.Unauthenticated
	48, // 40: sources.Teams.authenticated:type_name -> credentials.ClientCredentials
	40, // 41: sources.Teams.oauth:type_name -> credentials.Oauth2
	39, // 42: sources.Forager.unauthenticated:type_name -> credentials.Unauthenticated
	49, // 43: sources.Forager.since:type_name -> google.protobuf.Timestamp
	46, // 44: sources.SlackRealtime.tokens:type_name -> credentials.SlackTokens
	40, // 45: sources.Sharepoint.oauth:type_name -> credentials.Oauth2
	40, // 46: sources.AzureRepos.oauth:type_name -> credentials.Oauth2
	39, // 47: sources.Postman.unauthenticated:type_name -> credentials.Unauthenticated
	47, // 48: sources.Webhook.header:type_name -> credentials.Header
	39, // 49: sources.DockerHub.unauthenticated:type_name -> credentials.Unauthenticated
	38, // 50: sources.DockerHub.basic_auth:type_name -> credentials.BasicAuth
...
func file_sources_proto_init() {
	...
	file_sources_proto_msgTypes[23].OneofWrappers = []any{
	...
	file_sources_proto_msgTypes[28].OneofWrappers = []any{
